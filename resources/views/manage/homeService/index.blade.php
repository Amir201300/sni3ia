...
@section('content')
    ...
    <div class="page-wrapper">
                    ...
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">خدمات منزليه </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block align-items-center m-b-30">
                                <h4 class="card-title">خدمات منزليه</h4>
                                <div class="ml-auto">
                                    <div class="btn-group">
        ...
        <!-- footer -->
        <!-- ============================================================== -->
    @include('manage.homeService.form')

    @include('manage.homeService.show')
...
@section('script')
    ...
    @include('manage.homeService.script')

...
<script>
    $('#formSubmit').submit(function(e){
        ...
        url = save_method == 'add' ? "{{route('homeService.store')}}" : "{{route('homeService.update')}}" ;
...
<script>
    function edit(id)
    {
        ...
        $.ajax({
            url : '/manage/homeService/show/' +id,
            type : 'get',
            success : function(data){
...
<script>
    ...
    function yesDelete()
    {
        ...
        if(checkNum == 1){
            deleteProccess("/manage/homeService/delete/" +id_num);
        }else{

            deleteProccess("/manage/homeService/delete/"+checkArray +'?type=2');
...
<script>
    $('#seachForm').submit(function(e){
        ...
        table.ajax.url('/manage/homeService/search?'+formData);
        table.ajax.reload();
    })

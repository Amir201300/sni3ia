...
@section('content')
    ...
    <div class="page-wrapper">
                    ...
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">خدمات 24/7</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block align-items-center m-b-30">
                                <h4 class="card-title">خدمات 24/7 </h4>
                                <div class="ml-auto">
                                    <div class="btn-group">
        ...
        <!-- footer -->
        <!-- ============================================================== -->
    @include('manage.Live_service.form')

    @include('manage.Live_service.show')
...
@section('script')
    ...
    @include('manage.Live_service.script')

...
<script>
    $('#formSubmit').submit(function(e){
        ...
        url = save_method == 'add' ? "{{route('Industrial.store')}}" : "{{route('Industrial.update')}}" ;
...
<script>
    ...
    function yesDelete()
    {
        ...
        if(checkNum == 1){
            deleteProccess("/manage/Industrial/delete/" +id_num);
        }else{

            deleteProccess("/manage/Industrial/delete/"+checkArray +'?type=2');
...
<script>
    $('#seachForm').submit(function(e){
        ...
        table.ajax.url('/manage/Industrial/search?'+formData);
        table.ajax.reload();
    })
